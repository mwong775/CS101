...
clean : 
	$(REMOVE) FindComponents GraphClient GraphTest FindComponents.o GraphClient.o $(BASE_OBJECTS) 

checkFind : 
	FindComponents $(MEMCHECK) FindComponents in3 junk3 

checkClient : 
	GraphClient $(MEMCHECK) GraphClient 